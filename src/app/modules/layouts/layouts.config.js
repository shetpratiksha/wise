(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider) {
        ...
        .state('triangular.standard-page',  {
            ...
            templateUrl: 'app/modules/layouts/standard-page.tmpl.html',
            data: {
                layout: {
        ...
        .state('triangular.no-scroll-page',  {
            ...
            templateUrl: 'app/modules/layouts/no-scroll-page.tmpl.html',
            data: {
                layout: {
        ...
        .state('triangular.layouts-composer', {
            ...
            templateUrl: 'app/modules/layouts/composer.tmpl.html',
