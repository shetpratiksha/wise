(function() {
    ...
    function themesConfig ($mdThemingProvider, triThemingProvider, triSkinsProvider) {
        ...
        $mdThemingProvider.definePalette('ams-accent', {
            '50': 'ebf2fe',
            '100': 'cddffc',
            '200': 'acc9fa',
            '300': '8ab3f8',
        ...
        $mdThemingProvider.definePalette('ams-toolbar', {
          '50': 'fcfdfd',
          '100': 'f8f9fa',
          '200': 'f4f5f7',
          '300': 'eff1f4',
        ...
        triThemingProvider.theme('ams-theme')
        .primaryPalette('blue-grey')
        .accentPalette('ams-accent',{
            'default':'500'
        })
        .warnPalette('red')
        .backgroundPalette('grey');

        triThemingProvider.theme('ams-light-grey')
        .primaryPalette('ams-toolbar',{
            'default': '500'
        })
        .accentPalette('grey')
        .warnPalette('deep-orange');
        ...
        triSkinsProvider.skin('ams-cloud', 'Ams Cloud')
        .sidebarTheme('ams-theme')
        .toolbarTheme('ams-light-grey')
        .logoTheme('ams-theme')
        .contentTheme('ams-theme');
         ...
         *  SET DEFAULT SKIN
         */
        triSkinsProvider.setSkin('ams-cloud');
    }
})();
