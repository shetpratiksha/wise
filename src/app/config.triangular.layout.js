(function() {
    ...
    function config(triLayoutProvider) {
        ...
        triLayoutProvider.setDefaultOption('sidebarRightTemplateUrl', 'app/layouts/rightsidenav/rightsidenav.ams.tmpl.html');
        triLayoutProvider.setDefaultOption('sidebarRightController', 'RightSidenavAmsController');
